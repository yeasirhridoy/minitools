...
const inputTimezone = ref(null);
const outputTimezone = ref(null);
        ...
        <div class="grid">
          <div class="col-12 md:col-6">
            <div class="p-inputgroup flex-1">
              ...
              <Dropdown v-model="inputTimezone" :options="timezones" option-value="text" option-label="text"
          ...
          <div class="col-12 md:col-6">
            <div class="p-inputgroup flex-1">
              ...
              <Dropdown v-model="outputTimezone" :options="timezones" option-value="text" option-label="text"
                        placeholder="Timezone"/>
            </div>
          </div>
        </div>
